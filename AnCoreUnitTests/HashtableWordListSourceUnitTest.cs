...
{
  [TestClass]
  public partial class HashtableWordListSourceUnitTest
  {
    [TestMethod]
    ...
    public void Constructor_Throws_WhenNullPath()
    {
      ...
      //Act
      //Assert
      var objectUnderTest = new HashtableWordListSource(filePath, language, extraPath, exclusionPath, wordListRetriever);
    }
